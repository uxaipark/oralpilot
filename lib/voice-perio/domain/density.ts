...
export const DENSITIES: Density[] = [
  {
    id: 'comfortable',
    label: 'Comfortable',
    hint: 'Full size — a desktop monitor',
    cw: 18,
    gut: 124,
    gap: 22,
  },
  {
    id: 'compact',
    label: 'Compact',
    hint: 'Tighter columns — a large tablet',
    cw: 16,
    gut: 108,
    gap: 18,
  },
  {
    id: 'tight',
    label: 'Tight',
    hint: 'The whole arch on a narrow screen',
    cw: 14,
    gut: 96,
    gap: 14,
  },
